...
export async function getTemplate(id: string | number) {
  ...
  switch (item.path) {
    case "Arturia - Newsletter.json":
      data = (await import("@demo/templates/Arturia - Newsletter.json"))
        .default;
      break;
    ...
    case "MJML Code - Newsletter.json":
      data = (await import("@demo/templates/MJML Code - Newsletter.json"))
        .default;
      break;
    ...
    case "Stay Updated On Our Shopping.json":
      data = (await import("@demo/templates/Stay Updated On Our Shopping.json"))
        .default;
      break;

    case "We Serve Healthy & Delicious Foods.json":
      data = (
        await import("@demo/templates/We Serve Healthy & Delicious Foods.json")
      ).default;
      break;

    case `St. Patrick's Day - Newsletter.json`:
      data = (await import(`@demo/templates/St. Patrick Day - Newsletter.json`))
        .default;
      break;
  }
  return data;
